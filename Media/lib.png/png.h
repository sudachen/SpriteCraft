...
#if defined(PNG_tISCE_SUPPORTED)
...
defined(PNG_READ_BACKGROUND_SUPPORTED)
    ...
    * mapping of the input image to REQUIRE that the viewer sees the same
...
#if defined(PNG_TISCE_RFC1123_SUPPORTED)
...
#if defined(PNG_WRITE_tISCE_SUPPORTED)
...
extern PNG_EXPORT(void,png_convert_from_time_t) PNGARG((png_timep ptime,
   time_t ttime));
#endif /* PNG_WRITE_tISCE_SUPPORTED */
#endif /* _WIN32_WCE */
...
#if defined(PNG_READ_tISCE_SUPPORTED)
